...
import static com.example.marian.finalbakingapp2.database.RecipeContract.RECIPE_CONTENT_URI;
...
public class StepActivity extends AppCompatActivity implements StepAdapter.OnStepListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        TwoPane = findViewById(R.id.detail_linear_layout) != null;
    ...
    public void onStepSelected(int position)
    {
        ...
        if (TwoPane)
        {
            ...
            bundle.putBoolean(PANES, TwoPane);
        ...
        else if (TwoPane && position == 0)
       {
        ...
        else
        {
            ...
            bundle.putBoolean(PANES, TwoPane);
            bundle.putParcelableArrayList(STEPS, recipe.getSteps());
            Intent intent = new Intent(StepActivity.this, StepDetailActivity.class);
            ...
            case R.id.action_favorite:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN)
                {
                    if (isFavorite())
                    {
                        ...
                        Toast.makeText(this, String.format(getString(R.string.favorite_recipe_removed), recipe.getName()), Toast.LENGTH_LONG).show();
                    } else {
                        addRecipe();
                        item.setIcon(R.drawable.ic_favorite_added);
                        Toast.makeText(this, String.format(getString(R.string.favorite_recipe_added), recipe.getName()), Toast.LENGTH_LONG).show();
                    }
                }
                return true;
            default:
    ...
    private void geIngredient(ArrayList<Ingredient> ingredients)
    {
